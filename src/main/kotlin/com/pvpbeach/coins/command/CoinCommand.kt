...
object CoinCommand : BaseCommand()
{
    ...
    @CommandAlias("give")
    fun give(sender: CommandSender, target: Player, amount: Int, @Default("coins") currency: Currency)
    {
    ...
    @CommandAlias("set")
    fun set(sender: CommandSender, target: Player, amount: Int, @Default("coins") currency: Currency)
    {
        CurrencyWrapper[target.uniqueId][currency] = amount
    }
    ...
    @CommandAlias("remove")
    fun remove(sender: CommandSender, target: Player, amount: Int, @Default("coins") currency: Currency)
    {
        CurrencyWrapper[target.uniqueId][currency] -= amount
    }
}